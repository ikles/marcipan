...
class JFormFieldCktestcarouselckparamsplugin extends JFormField {

	protected $type = 'cktestcarouselckparamsplugin';
	...
	protected function getLabel() {
		...
		if ((string) $this->element['hr'] == 'true') {
			...
			$testpatch = $this->testPatch('carouselckparams');
	...
	protected function testPatch($component) {
		if (JFile::exists(JPATH_ROOT . '/plugins/system/' . $component . '/' . $component . '.php') && JPluginHelper::isEnabled('system', $component)) {
			...
			return JText::_('MOD_CAROUSELCK_SPACER_' . strtoupper($component) . '_PATCH_INSTALLED');
		}
		return false;
	}
