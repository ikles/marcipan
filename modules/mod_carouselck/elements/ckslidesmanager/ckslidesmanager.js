...
function addslideck(imgname, imgcaption, imgthumb, imglink, imgtarget, imgvideo, slideselect, imgalignment, articleid, imgtime, articlename, imgtitle) {
	...
	if (!slideselect) {
		slideselect = '';
		slideselectoption = '<option value="image" selected="selected">' + Joomla.JText._('MOD_CAROUSELCK_IMAGE', 'Image') + '</option><option value="video">' + Joomla.JText._('MOD_CAROUSELCK_VIDEO', 'Video') + '</option>';
	} else {
		if (slideselect == 'image') {
			slideselectoption = '<option value="image" selected="selected">' + Joomla.JText._('MOD_CAROUSELCK_IMAGE', 'Image') + '</option><option value="video">' + Joomla.JText._('MOD_CAROUSELCK_VIDEO', 'Video') + '</option>';
		} else {
			slideselectoption = '<option value="image">' + Joomla.JText._('MOD_CAROUSELCK_IMAGE', 'Image') + '</option><option value="video" selected="selected">' + Joomla.JText._('MOD_CAROUSELCK_VIDEO', 'Video') + '</option>';
		}
	}
	...
	if (!imgalignment) {
		...
		imgdataalignmentoption = '<option value="default" selected="selected">Default</option>'
				+ '<option value="topLeft">' + Joomla.JText._('MOD_CAROUSELCK_TOPLEFT', 'top left') + '</option>'
				+ '<option value="topCenter">' + Joomla.JText._('MOD_CAROUSELCK_TOPCENTER', 'top center') + '</option>'
				+ '<option value="topRight">' + Joomla.JText._('MOD_CAROUSELCK_TOPRIGHT', 'top right') + '</option>'
				+ '<option value="centerLeft">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLELEFT', 'center left') + '</option>'
				+ '<option value="center">' + Joomla.JText._('MOD_CAROUSELCK_CENTER', 'center') + '</option>'
				+ '<option value="centerRight">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLERIGHT', 'center right') + '</option>'
				+ '<option value="bottomLeft">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMLEFT', 'bottom left') + '</option>'
				+ '<option value="bottomCenter">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMCENTER', 'bottom center') + '</option>'
				+ '<option value="bottomRight">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMRIGHT', 'bottom right') + '</option>';
	} else {
		if (imgalignment == 'topLeft') {
			imgdataalignmentoption = '<option value="default">Default</option>'
					+ '<option value="topLeft" selected="selected">' + Joomla.JText._('MOD_CAROUSELCK_TOPLEFT', 'top left') + '</option>'
					+ '<option value="topCenter">' + Joomla.JText._('MOD_CAROUSELCK_TOPCENTER', 'top center') + '</option>'
					+ '<option value="topRight">' + Joomla.JText._('MOD_CAROUSELCK_TOPRIGHT', 'top right') + '</option>'
					+ '<option value="centerLeft">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLELEFT', 'center left') + '</option>'
					+ '<option value="center">' + Joomla.JText._('MOD_CAROUSELCK_CENTER', 'center') + '</option>'
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					+ '<option value="topLeft">' + Joomla.JText._('MOD_CAROUSELCK_TOPLEFT', 'top left') + '</option>'
					+ '<option value="topCenter" selected="selected">' + Joomla.JText._('MOD_CAROUSELCK_TOPCENTER', 'top center') + '</option>'
					+ '<option value="topRight">' + Joomla.JText._('MOD_CAROUSELCK_TOPRIGHT', 'top right') + '</option>'
					+ '<option value="centerLeft">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLELEFT', 'center left') + '</option>'
					+ '<option value="center">' + Joomla.JText._('MOD_CAROUSELCK_CENTER', 'center') + '</option>'
					+ '<option value="centerRight">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLERIGHT', 'center right') + '</option>'
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					+ '<option value="topLeft">' + Joomla.JText._('MOD_CAROUSELCK_TOPLEFT', 'top left') + '</option>'
					+ '<option value="topCenter">' + Joomla.JText._('MOD_CAROUSELCK_TOPCENTER', 'top center') + '</option>'
					+ '<option value="topRight" selected="selected">' + Joomla.JText._('MOD_CAROUSELCK_TOPRIGHT', 'top right') + '</option>'
					+ '<option value="centerLeft">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLELEFT', 'center left') + '</option>'
					+ '<option value="center">' + Joomla.JText._('MOD_CAROUSELCK_CENTER', 'center') + '</option>'
					+ '<option value="centerRight">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLERIGHT', 'center right') + '</option>'
					+ '<option value="bottomLeft">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMLEFT', 'bottom left') + '</option>'
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					...
					+ '<option value="topCenter">' + Joomla.JText._('MOD_CAROUSELCK_TOPCENTER', 'top center') + '</option>'
					+ '<option value="topRight">' + Joomla.JText._('MOD_CAROUSELCK_TOPRIGHT', 'top right') + '</option>'
					+ '<option value="centerLeft" selected="selected">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLELEFT', 'center left') + '</option>'
					+ '<option value="center">' + Joomla.JText._('MOD_CAROUSELCK_CENTER', 'center') + '</option>'
					+ '<option value="centerRight">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLERIGHT', 'center right') + '</option>'
					+ '<option value="bottomLeft">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMLEFT', 'bottom left') + '</option>'
					+ '<option value="bottomCenter">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMCENTER', 'bottom center') + '</option>'
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					...
					+ '<option value="topRight">' + Joomla.JText._('MOD_CAROUSELCK_TOPRIGHT', 'top right') + '</option>'
					+ '<option value="centerLeft">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLELEFT', 'center left') + '</option>'
					+ '<option value="center" selected="selected">' + Joomla.JText._('MOD_CAROUSELCK_CENTER', 'center') + '</option>'
					+ '<option value="centerRight">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLERIGHT', 'center right') + '</option>'
					+ '<option value="bottomLeft">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMLEFT', 'bottom left') + '</option>'
					+ '<option value="bottomCenter">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMCENTER', 'bottom center') + '</option>'
					+ '<option value="bottomRight">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMRIGHT', 'bottom right') + '</option>';
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					...
					+ '<option value="centerLeft">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLELEFT', 'center left') + '</option>'
					+ '<option value="center">' + Joomla.JText._('MOD_CAROUSELCK_CENTER', 'center') + '</option>'
					+ '<option value="centerRight" selected="selected">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLERIGHT', 'center right') + '</option>'
					+ '<option value="bottomLeft">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMLEFT', 'bottom left') + '</option>'
					+ '<option value="bottomCenter">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMCENTER', 'bottom center') + '</option>'
					+ '<option value="bottomRight">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMRIGHT', 'bottom right') + '</option>';
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					...
					+ '<option value="center">' + Joomla.JText._('MOD_CAROUSELCK_CENTER', 'center') + '</option>'
					+ '<option value="centerRight">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLERIGHT', 'center right') + '</option>'
					+ '<option value="bottomLeft" selected="selected">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMLEFT', 'bottom left') + '</option>'
					+ '<option value="bottomCenter">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMCENTER', 'bottom center') + '</option>'
					+ '<option value="bottomRight">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMRIGHT', 'bottom right') + '</option>';
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					...
					+ '<option value="centerRight">' + Joomla.JText._('MOD_CAROUSELCK_MIDDLERIGHT', 'center right') + '</option>'
					+ '<option value="bottomLeft">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMLEFT', 'bottom left') + '</option>'
					+ '<option value="bottomCenter" selected="selected">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMCENTER', 'bottom center') + '</option>'
					+ '<option value="bottomRight">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMRIGHT', 'bottom right') + '</option>';
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					...
					+ '<option value="bottomLeft">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMLEFT', 'bottom left') + '</option>'
					+ '<option value="bottomCenter">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMCENTER', 'bottom center') + '</option>'
					+ '<option value="bottomRight" selected="selected">' + Joomla.JText._('MOD_CAROUSELCK_BOTTOMRIGHT', 'bottom right') + '</option>';
		} else {
			imgdataalignmentoption = '<option value="default" selected="selected">Default</option>'
					+ '<option value="topLeft">' + Joomla.JText._('MOD_CAROUSELCK_TOPLEFT', 'top left') + '</option>'
					+ '<option value="topCenter">' + Joomla.JText._('MOD_CAROUSELCK_TOPCENTER', 'top center') + '</option>'
	...
	ckslide.html('<div class="ckslidehandle"><div class="ckslidenumber">' + index + '</div></div><div class="ckslidecontainer">'
			...
			+ '<a class="modal ckselectimg" href="' + JURI + 'administrator/index.php?option=com_media&view=images&tmpl=component&e_name=ckslideimgname' + index + '" rel="{handler: \'iframe\', size: {x: 800, y: 500}}" >' + Joomla.JText._('MOD_CAROUSELCK_SELECTIMAGE', 'select image') + '</a></div>'
			// + '<div class="cksliderow2">'
			// + '<span class="ckslidelabel">' + Joomla.JText._('MOD_CAROUSELCK_USETOSHOW', 'Display') + '</span><select class="ckslideselect">' + slideselectoption + '</select>'
			// + '<span><img src="../modules/mod_carouselck/elements/images/hourglass.png" style="float: none; padding-top: 5px;" align="top" class="hasTip" title="' + Joomla.JText._('MOD_CAROUSELCK_SLIDETIME', 'enter a specific time value for this slide, else it will be the default time') + '"/><input name="ckslideimgtime' + index + '" class="ckslideimgtime" type="text" value="' + imgtime + '" onchange="javascript:storesetwarning();" style="width:25px;" /></span><span>ms</span>'
			// + '</div>'
			+ '<div class="cksliderow"><span class="ckslidelabel">' + Joomla.JText._('MOD_CAROUSELCK_TITLE', 'Title') + '</span><input name="ckslidetitletext' + index + '" class="ckslidetitletext" type="text" value="' + imgtitle + '" onchange="javascript:storesetwarning();" /></div>'
			...
			+ '</div>'
			+ '<div class="ckslideaccordeoncontent">'
			+ '<div class="cksliderow" id="cksliderowarticle' + index + '"><span class="ckslidelabel">' + Joomla.JText._('MOD_CAROUSELCK_ARTICLE_ID', 'Article ID') + '</span><input name="ckslidearticleid' + index + '" class="ckslidearticleid input-medium" id="ckslidearticleid' + index + '" style="width:20px" type="text" value="' + articleid + '" disabled="disabled" onchange="javascript:storesetwarning();" /><input name="ckslidearticlename' + index + '" class="ckslidearticlename input-medium" id="ckslidearticlename' + index + '" type="text" value="' + articlename + '" disabled="disabled" /><a id="ckslidearticlebuttonSelect" class="modal btn" href="index.php?option=com_content&amp;layout=modal&amp;view=articles&amp;tmpl=component&amp;function=jSelectArticle_ckslidearticleid' + index + '" rel="{handler: \'iframe\', size: {x: 800, y: 450}}" style="display:inline-block;margin:0 5px 0 5px;">' + Joomla.JText._('MOD_CAROUSELCK_SELECT', 'Select') + '</a><a class="btn" href="javascript:void(0)" onclick="document.getElementById(\'ckslidearticleid' + index + '\').value=\'\';document.getElementById(\'ckslidearticlename' + index + '\').value=\'\';">' + Joomla.JText._('MOD_CAROUSELCK_CLEAR', 'Clear') + '</a>'
			+(articleid != '' ? '<a id="ckslidearticlebuttonSelect" class="modal btn" href="index.php?option=com_content&layout=modal&tmpl=component&task=article.edit&id='+articleid+'" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'+Joomla.JText._('MOD_CAROUSELCK_EDIT', 'Edit')+'</a>' : '')
			+'</div>'
			+ '</div>'
			+ '</div></div>'
